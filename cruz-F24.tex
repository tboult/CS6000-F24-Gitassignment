...
A1. The Predictive maintenance problem can be identified as predicting when an industrial machine part will fail before it fails, so that
the part can be replaced ahead of time. This is valuable to companies and governments because it is efficient, sustainable, and effective. There are also cost
savings as well. But the biggest part is that the machines are talking to eachother without human intervention. Digital twins is one of the advantages which reports machine
health by having a digital twin to reference.

 \subsection    What was the most challenging part of your project?
 

 The most challenging part was trying to reduce dimensions and keep significant information for training.
